...
function PlayControls() {
	...
	const globalStep = useSelector(getStep);
	const globalStepsLength = useSelector(getMaxStep);
	...
	const startAnimation = useCallback(
		...
		[globalStepsLength, dispatch, stopAnimation]
	);
	...
	return (
		<StyledPlayControls>
			<Container>
				<Bar>
					<PlayProgressBar
						freeze={() => dispatch(stopAnimation())}
						unfreeze={() => dispatch(startAnimation())}
