export function insertSorted(arr: number[], num: number): number[] {
    let left = 0;
...
export function removeSorted(arr: number[], value: number): number[] {
...
export function findClosest(arr: number[], target: number): number | null {
