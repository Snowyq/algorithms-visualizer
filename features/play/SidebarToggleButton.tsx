...
const CollapseButton = styled.button<{ $fontSize?: string }>`
...
const arrowStates: Record<SidebarState, ReturnType<typeof css>> = {
    hidden: css``,
    visible: css`
        rotate: 180deg;
    `,
};
const ArrowCollapse = styled.div<{ state: SidebarState }>`
    position: absolute;
    font-size: 2rem;
    top: 50%;
    left: 10%;
